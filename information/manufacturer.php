...
if (isset($_POST['search'])) {
    ...
    $sql = "SELECT * FROM `manufacturer` WHERE CONCAT(`name`, `nation`, `address`, `hotline`, `email`, `website`, `topmanager`, `service`) LIKE '%$valueToSearch%'";
    ...
    if ($name == "" && $nation == "" && $address == "" && $topmanager == "") {
        ...
        $sql = "SELECT * FROM `manufacturer` WHERE 0";
    ...
    <div id="wrapper">
        ...
        <header id="header">
            <div class="inner">
                ...
                <!-- Logo -->
                <a href="manufacturer.php" class="logo">
                    <span class="fa fa-car"></span> <span class="title">Show Manufacturers</span>
                </a>
                ...
                <td>
                    ...
                    <form action="manufacturer.php" method="post">
                        <div class="input-group mb-3">
                            ...
                            <a class="btnAdd" href="../function/add_manu.php" style="float:right;"></a>
                    ...
                    <div id="myModal" class="modal">
                        ...
                        <div class="modal-content">
                            ...
                            <legend>Manufacturer Filter</legend>
                                ...
                                <fieldset>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="custom-select" id="inputGroupSelect01" name="name-filter">
                                            <?php
                                            $name_query = 'SELECT DISTINCT `name` FROM `manufacturer` ORDER BY `name`';
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="custom-select" id="inputGroupSelect01" name="nation-filter">
                                            <?php
                                            $type_query = 'SELECT DISTINCT `nation` FROM `manufacturer` ORDER BY `nation`';
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="custom-select" id="inputGroupSelect01" name="address-filter">
                                            <?php
                                            $seat_query = 'SELECT DISTINCT `address` FROM `manufacturer` ORDER BY `address`';
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="custom-select" id="inputGroupSelect01" name="topmanager-filter">
                                            <?php
                                            $seat_query = 'SELECT DISTINCT `topmanager` FROM `manufacturer` ORDER BY `topmanager`';
                                            $seat_sql = mysqli_query($conn, $seat_query);
                                            $row = mysqli_num_rows($seat_sql);
                                            echo "<option selected></option>";
                                            while ($row = mysqli_fetch_array($seat_sql)) {
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-info" href="../function/update_manu.php?mid=<?php echo $row['mid']; ?>">
                                                Edit</a>
                                            &nbsp;<a class="btn btn-danger" href="../function/delete_manu.php?mid=<?php echo $row['mid']; ?>">
                                                Delete</a></td>
                                    </tr>
